package com.example.vektorelweatherapp
//101966fea2d56cba82fea22c646e49cf
...
class MainActivity : AppCompatActivity() {
    ...
    val API : String = "101966fea2d56cba82fea22c646e49cf"
    ...
    inner class WeatherTask () : AsyncTask<String,Void,String>(){
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                val updatedAd : Long = jsonObj.getLong("dt")
                val updatedAdText = "Updated At : " + SimpleDateFormat("dd/MM/yyyy hh:mm a", Locale.ENGLISH).format(
                    Date(updatedAd * 1000)
                )
                ...
                findViewById<TextView>(R.id.updated_ad).text = updatedAdText
